...
class Config:
    ...
    # Mapbox access token from environment variable (required)
    MAPBOX_ACCESS_TOKEN = os.getenv('MAPBOX_ACCESS_TOKEN')
    if not MAPBOX_ACCESS_TOKEN:
        raise ValueError("MAPBOX_ACCESS_TOKEN environment variable is required. Please set it in your .env file.")
...
def create_visualization(overview: pd.DataFrame, cycle_data: pd.DataFrame, 
    ...
    fig.update_layout(
        ...
        mapbox=dict(
            ...
            style='light',  # Grey/light basemap style
